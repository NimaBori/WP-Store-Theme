...
$menu_class = \Store\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id( 'store-header-menu' );
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          foreach ( $header_menus as $menu_item ) {
            if ( ! $menu_item->menu_item_parent ) {
              $child_menu_items = $menu_class->get_child_menu_items( $menu_item->ID, $header_menus );
